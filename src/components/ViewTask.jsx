...
export default function ViewTask() {
  ...
  return (
    <div className="mt-20 w-[500px] ml-[100px]">
      {data && (
        <div className="bg-gray-100 text-center shadow-xl" key={data.id}>
          <h1 className="text-[30px] font-medium py-[10px]">{data.title}</h1>
      ...
      <Link to="/">
        <button className="bg-gradient-to-tr from-violet-600 to-sky-700 px-[30px] py-[5px] text-white font-medium rounded-md mt-[30px] w-full">
          Go to Home
        </button>
      </Link>
    </div>
